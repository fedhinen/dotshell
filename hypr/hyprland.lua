...
local menu        = "qs ipc -p /usr/share/chillpill-shell call launcher toggle"
...
-- 1Password (picker de autofill, ventana principal)
hl.window_rule({
...
-- Diálogos de "Abrir/Guardar archivo" (xdg-desktop-portal, Chrome, etc.)
hl.window_rule({
...
-- Ventanas de confirmación/diálogo pequeñas en general
hl.window_rule({
    name  = "float-dialogs",
...
-- Picker de compartir pantalla (xdg-desktop-portal-hyprland)
hl.window_rule({
...
-- Kitty flotante si lo abres como scratchpad/dropdown (ajusta el class si usas uno especial)
-- hl.window_rule({
--     name  = "float-kitty-dropdown",
...
-- Picture-in-Picture (Chrome, YouTube, etc.)
hl.window_rule({
    name  = "float-pip",
...
-- Cerrar ventana activa (cierre "suave", pide confirmación a la app si aplica)
hl.bind(mainMod .. " + Q", hl.dsp.window.close())

-- Forzar cierre (kill) por si una app queda colgada
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.window.kill())

-- Toggle floating para cualquier ventana
hl.bind(mainMod .. " + V", hl.dsp.window.float({ action = "toggle" }))
