...
- Mini Dashboard               : Profile Image, Username, Hostname, Uptime, Battery, CPU, RAM, Disk, cached Codex weekly usage, Basic network info, Today bandwidth usage, Datetime, Weather and Calendar
